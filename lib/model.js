...
class Model {
  ...
  static init(attributes, options) { // testhint options:none
    ...
    this._schemaFixed = this.options.schemaFixed;
  ...
  static changeSchema(schema, connection) {
    schema = "cliente_" + schema;
    Object.keys(connection.models).forEach(model => {
      if (!connection.models[model]._schemaFixed) {
        connection.models[model]._schema = schema
      }
    });
    const clone = class extends this {};
    Object.defineProperty(clone, 'name', {value: this.name});
    if (!clone._schemaFixed) {
      clone._schema = schema;
    }
    return clone;
  }
